																													...
																													success: function (retornoA960) {
																														...
																														oModel.read("/A959", {
																															success: function (retornoA959) {
																																var txTabPrecoMatValor2 = db.transaction("A959", "readwrite");
																																var objTabPrecoMatValor2 = txTabPrecoMatValor2.objectStore("A959");

																																for (i = 0; i < retornoA959.results.length; i++) {

																																	var objBancoTabPrecoMatValor2 = {
																																	...
																																	var requestTabPrecoMatValor = objTabPrecoMatValor.add(objBancoTabPrecoMatValor2);
																																	...
																																	oModel.read("/EntregaFuturaTopo", {
																																			success: function (retornoEntregaFuturaTopo) {
																																				...
																																				for (i = 0; i < retornoEntregaFuturaTopo.results.length; i++) {

																																					var objBancoEntregaFuturaTopo = {
																																						idEntregaFuturaTopo: retornoEntregaFuturaTopo.results[i].Vbeln,
																																						IRepresentante: retornoEnetregaFuturaTopo.results[i].IRepresentante,
																																						Vbeln: retornoEnetregaFuturaTopo.results[i].Vbeln,
																																						Kunrg: retornoEnetregaFuturaTopo.results[i].Kunrg,
																																						Aubel: retornoEnetregaFuturaTopo.results[i].Aubel,
																																						Aupos: retornoEnetregaFuturaTopo.results[i].Aupos,
																																						Bstkd: retornoEnetregaFuturaTopo.results[i].Bstkd,
																																						Matnr: retornoEnetregaFuturaTopo.results[i].Matnr,
																																						Arktx: retornoEnetregaFuturaTopo.results[i].Arktx,
																																						Fkimg: retornoEnetregaFuturaTopo.results[i].Fkimg,
																																						Lifnr: retornoEnetregaFuturaTopo.results[i].Lifnr,
																																						NameOrg1: retornoEnetregaFuturaTopo.results[i].NameOrg1,
																																						NameOrg2: retornoEnetregaFuturaTopo.results[i].NameOrg2,

																																					};

																																					var requestEntregaFuturaTopo = objTabEntregaFuturaTopo.add(
																																						objBancoEntregaFuturaTopo);
																																					...
																																					oModel.read("/EntregaFuturaDet", {
																																								success: function (retornoEntregaFuturaDet) {
																																									var txEntregaFuturaDet = db.transaction("retornoEntregaFuturaDet", "readwrite");
																																									var objEntregaFuturaDet = txEntregaFuturaDet.objectStore("EntregaFuturaTopo");

																																									for (i = 0; i < retornoEntregaFuturaDet.results.length; i++) {

																																										var objBancoEntregaFuturaTopo = {
																																											idEntregaFuturaDet: retornoEnetregaFuturaDet.results[i].Vbeln + 
																																																	retornoEnetregaFuturaDet.results[i].Vgbel,
																																											IRepresentante: retornoEnetregaFuturaDet.results[i].IRepresentante,
																																											Vbeln: retornoEnetregaFuturaDet.results[i].Vbeln,
																																											Kunnr: retornoEnetregaFuturaDet.results[i].Kunnr,
																																											Bstkd: retornoEnetregaFuturaDet.results[i].Bstkd,
																																											Matnr: retornoEnetregaFuturaDet.results[i].Matnr,
																																											Arktx: retornoEnetregaFuturaDet.results[i].Arktx,
																																											Abgru: retornoEnetregaFuturaDet.results[i].Abgru,
																																											Kwmeng: retornoEnetregaFuturaDet.results[i].Kwmeng,
																																											Vgpos: retornoEnetregaFuturaDet.results[i].Vgpos,
																																											Vgbel: retornoEnetregaFuturaDet.results[i].Vgbel,
																																											Lifnr: retornoEnetregaFuturaDet.results[i].Lifnr,
																																											NameOrg1: retornoEnetregaFuturaDet.results[i].NameOrg1,
																																											NameOrg2: retornoEnetregaFuturaDet.results[i].NameOrg2
																																										};
																																																...
																																																for (i = 0; i < retornoA963.results.length; i++) {
																																																	...
																																																	var objBancoA963 = {
																																																		idA963: retornoA963.results[i].Werks + "." +
																																																			retornoA963.results[i].Lifnr + "." + retornoA962.results[i]
																																																			.Pltyp,
																																																							...
																																																							success: function (retornoA967) {
																																																								...
																																																								oModel.read("/Konm", {
																																																									success: function (retornoKonm) {
																																																										...
																																																										var txKonm = db.transaction("Konm",
																																																											"readwrite");
																																																										...
																																																										for (i = 0; i < retornoKonm.results.length; i++) {
																																																											...
																																																											requestKonm.onsuccess = function (
																																																												event) {
																																																												console.log(
																																																										...
																																																										oModel.read("/A968", {
																																																											success: function (retornoA968) {
																																																												...
																																																												for (i = 0; i < retornoA968.results
																																																													.length; i++) {

																																																													var objBancoA968 = {
																																																														idA968: retornoA968.results[i]
																																																															.Werks +
																																																															"." +
																																																															retornoA968.results[
																																																																i].Konda + "." +
																																																														...
																																																														werks: retornoA968.results[i]
																																																															.Werks,
																																																														konda: retornoA968.results[i]
																																																															.Konda,
																																																														kondm: retornoA968.results[i]
																																																															.Kondm,
																																																														pltyp: retornoA968.results[i]
																																																															.Pltyp,
																				...
																				onClose: function (oAction) {
																					if (oAction === sap.m.MessageBox.Action.YES) {
																						...
																						open.onsuccess = function () {
																							...
																							var vTables = ["A960", "Clientes", "A969", "Usuarios", "A965", "A963", "A966", "A964", "A962", "A961",
																								"Materiais",
																								"Konm",
																								"A968"
																							];
